...
package library.adapters
{
	...
	public class SwiftSuspendersInjector extends Injector implements IInjector
	{
		...
		public function SwiftSuspendersInjector(applicationDomain:ApplicationDomain = null, xmlConfig:XML = null)
		{
			/*if (xmlConfig)
			{
			...
			applicationDomain && setApplicationDomain(applicationDomain);
		}
		...
		{
			var injector:SwiftSuspendersInjector = new SwiftSuspendersInjector(applicationDomain);
